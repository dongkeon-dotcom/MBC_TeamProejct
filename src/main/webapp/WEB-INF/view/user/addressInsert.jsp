...
체크 박스 이름 전화번호 주소지 주소지 삭제 버튼 
     ...
     <table > 
<tr> <td></td> <td>배송이름 </td> <td>수령인 </td> <td>전화번호 </td> <td>주소 </td> <td>삭</td>
     <tr> <td><input type="checkbox" id="selectAll" onclick="toggleSelectAll()"></td> <td>이름</td> <td>전화번호</td><td>주소지</td><td>삭제/td>
